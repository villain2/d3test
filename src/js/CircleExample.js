...
{
    D3Test.Modules.D3Test.controller('HomeCtrl', ['$scope', '$element', function ($scope, $element)
    {
        var scope           = $scope;
        var mainContent     = $element.find('#mainContainer');
                ...
                function drawAngleMark(angle) {
                    var length = 30
                        ...
                        , coords = {
                            ...
                            , text: {
                                x: (radius + (2 * length)) * cos - length / 2
